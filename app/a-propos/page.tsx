...
export default function About(){return <SiteShell active="apropos"><main className="about-new">
 <section className="container about-hero"><div><p className="page-kicker">Notre Histoire</p><h1>Élever la <span>Performance</span>, Transformer les Carrières.</h1><p>Née au cœur de Casablanca, VERALYA est un écosystème conçu pour les professionnels ambitieux du Maroc qui cherchent à allier stabilité corporate et dynamisme moderne.</p><div className="about-actions"><Link className="button primary" href="/coaching">Découvrir notre coaching</Link><Link className="button outline" href="/contact">Contactez-nous</Link></div></div><div className="about-photo"><img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBIQVedrcHsTZ_nGJBiNrchFHEsTkUFJR5rvZLP1YrHsvPVO-v_mxE3EhuT4CU1PVfobmdk7E-mgukc4szYWU9umBzg8Oc8WLZzi9M581g9KFsMjmUWbR59RroCE-QEGrgRQotZR2b8DXx7hljmybjfNblmJhVhcXi9FklVrcHJzzwX-cY6wPEvvx24KNKVdWSEzF3R-ETrvaE3V_MP6zL27uKK2_-87VSTFP8JQCR5Kq6KvpvHr1FD" alt="Professionnels collaborant dans un bureau moderne à Casablanca"/><div><strong>Casablanca-Settat</strong><span>Notre Hub Stratégique</span></div></div></section>
